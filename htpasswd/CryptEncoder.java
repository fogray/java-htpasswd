...
public class CryptEncoder {
    ...
    private static final byte cov_2byte[] = { 0x2E, 0x2F, 0x30, 0x31, 0x32,
     ...
     *         encrypted password.
     */
    private static final byte[] crypt(byte salt[], byte original[]) {
    ...
    public static String encode(String username, String password)
        ...
        byte[] pwd = crypt(salt.toString().getBytes(encoding),
                username.getBytes(encoding));
